...
public class FairyTaleBoundaryTest {
    ...
    @MockitoBean FairyTaleControl fairyTaleControl;

    @Test
    public void getFairyTales_givenGetFairyTales_expectListOfFairyTales() throws Exception {
        when(fairyTaleControl.getFairyTales())
                .thenReturn(
                        List.of(SFFairyTale.getFairyTale("FT1"), SFFairyTale.getFairyTale("FT2")));

        testClient
                .get()
                .uri("api/v1/fairy-tales")
                .exchange()
                .expectStatus()
                .isOk()
                .expectBody()
    ...
    public void getNewFairyTaleLocation_givenGetNewLocation_expectAFairyTale() throws Exception {
        when(fairyTaleControl.getNextFairyTale(any(), any()))
                .thenReturn(SFFairyTale.getFairyTale("FT1"));

        testClient
                .get()
                .uri("api/v1/fairy-tales/500e8200-e22b-41d4-a716-446655440000/new-location")
                .exchange()
                .expectStatus()
                .isOk()
                .expectBody()
    ...
    @Test
    public void getNewFairyTaleLocation_givenGetNewLocationWithExcludedList_expectAFairyTale()
            throws Exception {
        var excludedUUIDs = List.of(UUID.randomUUID(), UUID.randomUUID());
        when(fairyTaleControl.getNextFairyTale(any(), eq(excludedUUIDs)))
                .thenReturn(SFFairyTale.getFairyTale("FT1"));
        ...
        testClient
                ...
                .uri(
                        uriBuilder ->
                                uriBuilder
                                        .path(
                                                "api/v1/fairy-tales/500e8200-e22b-41d4-a716-446655440000/new-location")
                                        .queryParam(
                                                "exclude",
