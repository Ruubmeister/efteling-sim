...
public class Employee implements DtoConvertible<EmployeeDto> {
    ...
    public Employee(String firstName, String lastName, List<WorkplaceSkill> skills) {
        ...
        this.currentLocation = GridLocationDto.builder()
    ...
    @Setter
    private GridLocationDto currentLocation;
    @Setter
    private GridLocationDto targetLocation;
    @Setter
    private boolean isMoving;
    @Setter
    private Queue<GridLocationDto> pathSteps = new LinkedList<>();
