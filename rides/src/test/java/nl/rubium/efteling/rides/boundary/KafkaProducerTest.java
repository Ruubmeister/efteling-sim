...
public class KafkaProducerTest {
    ...
    public void sendEvent_givenEventIsSend_expectKafkaTemplateIsCalled(){
        var event = new Event(EventSource.FAIRYTALE, EventType.WATCHINGFAIRYTALE, Map.of("something", "here"));

        this.kafkaProducer.sendEvent(event.getEventSource(), event.getEventType(), event.getPayload());
